...
public class HexMapGenerator : MonoBehaviour
{
    ...
    private HexCell GetRandomCell() => grid.GetCell(Random.Range(0, cellCount));
    ...
    private void CreateLand()
    {
        ...
        while (landBudget > 0)
        {
            ...
            if (Random.value < sinkProbability) landBudget = SinkTerrain(chunkSize, landBudget);
            else landBudget = RaiseTerrain(chunkSize, landBudget);
        }
    }
