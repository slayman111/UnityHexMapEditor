...
public class HexGridChunk : MonoBehaviour
{
    ...
    private static Color color1 = new(1f, 0f, 0f);
    private static Color color2 = new(0f, 1f, 0f);
    private static Color color3 = new(0f, 0f, 1f);
    ...
    private void TriangulateConnection(HexDirection direction, HexCell cell, EdgeVertices e1)
    {
        ...
        else TriangulateEdgeStrip(e1, color1, cell.TerrainTypeIndex, e2, color2, neighbor.TerrainTypeIndex, hasRoad);
